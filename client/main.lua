...
RegisterNetEvent('qb-multicharacter:client:spawnLastLocation', function(coords, cData) -- ps-housing
...
RegisterNUICallback('cDataPed', function(nData, cb) -- illenium-appearance
